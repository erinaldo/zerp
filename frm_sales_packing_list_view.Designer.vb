...
Partial Class frm_sales_packing_list_view
    ...
    Private Sub InitializeComponent()
		...
		Me.txt_priv_comment = New MemoEdit()
		Me.txt_orderid = New TextEdit()
		Me.LabelControl3 = New LabelControl()
		Me.txt_customer = New TextEdit()
		Me.LabelControl2 = New LabelControl()
		Me.txt_agent = New TextEdit()
		Me.LabelControl4 = New LabelControl()
		Me.LabelControl5 = New LabelControl()
		Me.btn_packed = New SimpleButton()
		Me.btn_print = New SimpleButton()
		Me.cbb_packer = New ComboBoxEdit()
		Me.lbl_packed_by = New LabelControl()
		Me.LabelControl1 = New LabelControl()
		Me.txt_pub_comment = New MemoEdit()
		Me.txt_box_no = New TextEdit()
		Me.LabelControl6 = New LabelControl()
		Me.LabelControl7 = New LabelControl()
		Me.LabelControl8 = New LabelControl()
		Me.txt_plastic_no = New TextEdit()
		Me.txt_rolls_no = New TextEdit()
		DirectCast(Me.txt_priv_comment.Properties, ISupportInitialize).BeginInit()
		DirectCast(Me.txt_orderid.Properties, ISupportInitialize).BeginInit()
		DirectCast(Me.txt_customer.Properties, ISupportInitialize).BeginInit()
		DirectCast(Me.txt_agent.Properties, ISupportInitialize).BeginInit()
		DirectCast(Me.cbb_packer.Properties, ISupportInitialize).BeginInit()
		DirectCast(Me.txt_pub_comment.Properties, ISupportInitialize).BeginInit()
		DirectCast(Me.txt_box_no.Properties, ISupportInitialize).BeginInit()
		DirectCast(Me.txt_plastic_no.Properties, ISupportInitialize).BeginInit()
		DirectCast(Me.txt_rolls_no.Properties, ISupportInitialize).BeginInit()
		Me.SuspendLayout()
		Me.txt_priv_comment.Location = New Point(12, 151)
		...
		Me.txt_orderid.Location = New Point(101, 32)
		...
		Me.LabelControl4.Location = New Point(12, 95)
		...
		Me.LabelControl5.Location = New Point(12, 127)
		...
		Me.btn_packed.ImageOptions.Image = My.Resources.apply_16x16
		Me.btn_packed.ImageOptions.ImageToTextAlignment = ImageAlignToText.LeftCenter
		Me.btn_packed.Location = New Point(12, 445)
		...
		Me.btn_print.ImageOptions.Image = My.Resources.print_32x322
		Me.btn_print.ImageOptions.ImageToTextAlignment = ImageAlignToText.TopCenter
		Me.btn_print.Location = New Point(303, 25)
		...
		Me.cbb_packer.Location = New Point(179, 381)
		...
		Me.cbb_packer.Properties.Buttons.AddRange(New EditorButton() {New EditorButton(ButtonPredefines.Combo)})
		Me.cbb_packer.Properties.TextEditStyle = TextEditStyles.DisableTextEditor
		...
		Me.lbl_packed_by.Location = New Point(179, 359)
		...
		Me.LabelControl1.Location = New Point(12, 240)
		...
		Me.txt_pub_comment.Location = New Point(12, 264)
		...
		Me.txt_box_no.Location = New Point(101, 356)
		...
		Me.txt_box_no.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Center
		...
		Me.LabelControl6.Location = New Point(12, 359)
		...
		Me.LabelControl7.Location = New Point(12, 387)
		...
		Me.txt_plastic_no.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Center
		Me.txt_plastic_no.Size = New System.Drawing.Size(62, 22)
		Me.txt_plastic_no.TabIndex = 64
		Me.txt_rolls_no.Location = New Point(101, 412)
		...
		Me.txt_rolls_no.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Center
		...
		DirectCast(Me.txt_priv_comment.Properties, ISupportInitialize).EndInit()
		DirectCast(Me.txt_orderid.Properties, ISupportInitialize).EndInit()
		DirectCast(Me.txt_customer.Properties, ISupportInitialize).EndInit()
		DirectCast(Me.txt_agent.Properties, ISupportInitialize).EndInit()
		DirectCast(Me.cbb_packer.Properties, ISupportInitialize).EndInit()
		DirectCast(Me.txt_pub_comment.Properties, ISupportInitialize).EndInit()
		DirectCast(Me.txt_box_no.Properties, ISupportInitialize).EndInit()
		DirectCast(Me.txt_plastic_no.Properties, ISupportInitialize).EndInit()
		DirectCast(Me.txt_rolls_no.Properties, ISupportInitialize).EndInit()
