...
Public Class frm_accounting_generate_voucher
    ...
    Private Sub btn_generate_Click(sender As Object, e As EventArgs) Handles btn_generate.Click
        ...
        Dim ans = MsgBox("Generate Payment Voucher?" & vbCrLf & vbCrLf & "Press 'Yes' to continue", vbQuestion + vbYesNo, "Confirmation")
        If ans = vbYes Then
            ...
            Try
                ...
                Dim cmd = New MySqlCommand("INSERT INTO ims_payment_vouchers (receipts, creation_date, collection_ref, supplier, generated_by)
                ...
                Dim update_cmd = New MySqlCommand("UPDATE ims_delivery_receipts SET payment_ref=@ref, status='PAID' WHERE payable_id=@id", conn)
